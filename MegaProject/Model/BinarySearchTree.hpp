...
/*
 ...
 notice that the non-recursive csase does NOTHING
 */
template <class Type>
void BinarySearchTree<Type> :: inOrderTraversal(BinarySearchTreeNode<Type> * inStart)
{
    if(inStart != nullptr)
    {
        ...
        cout << " NodeContents: " << inStart->getNodeData() << endl;
...
void BinarySearchTree<Type> :: removeNode(BinarySearchTreeNode<Type> * & removeMe)
{
    ...
    else
    {
        ...
        {
            previous->setRightChld(current->getLeftChild());
...
{
    return claculateSize(root);
}

template <class Type>
int BinarySearchTree<Type> :: getHeight()
{
    return claculateHeight(root);
}
...
template <class Type>
bool BinarySearchTree<Type> :: is Complete()
{
